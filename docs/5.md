...
### El soporte inicial es aquel en el que se insertaran los 3 servomotores, la pieza tiene como proposito sostener los servomotores fijos a ella ante cualquier movimiento que hagan, 
...
### El brazo pequeño es aquel que se inserta en el centro de cada servo motor, La pieza tiene como proposito ser parte del movimiento que balancea la pelota en la superficie final, esta pieza estara conectada con otra similar a ella, pero es importante que no se utilize el modelo de este brazop para el otro, ya que tienen ciertas diferencias que permiten que accionen correctamente
